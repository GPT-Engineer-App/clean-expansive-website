# clean-expansive-website

A personal website with follwoing design principles:
**Color Scheme:**
...
```sh
git clone https://github.com/GPT-Engineer-App/clean-expansive-website.git
cd clean-expansive-website
npm i
```
